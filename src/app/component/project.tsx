    ...
    <div id="Projects">
      <section className="text-gray-600 body-font bg-gray-100">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap -m-5 -mt-[5rem] cursor-pointer">
            {/* projects */}
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                <Image
                  src="/assests/Dynamic Resume Builder App.png"
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  ...
                  <Link
                    target="_blank"
                    href={
                      "https://vercel.com/asghar-zaheers-projects/dynamic-cv-builder-with-pdf-download"
                    }
                  >
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  ...
                  <Link
                    target="_blank"
                    href={"https://vercel.com/asghar-zaheers-projects/todo-app"}
                  >
                    <p className="leading-relaxed title-font text-lg font-bold text-center hover:text-green-800 text-blue-800 mb-3 ">
                      View Project
                    </p>
